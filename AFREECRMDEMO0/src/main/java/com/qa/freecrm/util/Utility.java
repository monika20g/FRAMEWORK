...
public class Utility {
	...
	public static boolean doIsDisplayed(By locator,WebDriver driver){
		return driver.findElement(locator).isDisplayed();
	}
	
	public static String doGetText(By locator,WebDriver driver){
...
public static void selectValueFromCalender(List<WebElement> elements,String values)
{
	...
	//Method Made by Monika
	public static void verifyTitleOfPage(WebDriver driver,String title)
	{
		WebDriverWait wait = new WebDriverWait(driver, 30);
	boolean titleOfPage=	wait.until(ExpectedConditions.titleIs(title));
